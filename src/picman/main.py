...
app.command("date",help="按日期整理照片")(organize_photos_by_date)
app.command("type",help="把文件中的视频以及字幕移动到文件夹")(organize_photos_by_filetype)
app.command("rate",help="按照打分等级整理照片")(organize_by_rating)
